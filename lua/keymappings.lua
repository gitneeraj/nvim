...
-- fast scrolling
vim.api.nvim_set_keymap('n', '<leader>n', '20j', opts)
vim.api.nvim_set_keymap('n', '<leader>u', '20k', opts)
vim.api.nvim_set_keymap('v', '<leader>n', '20j', opts)
vim.api.nvim_set_keymap('v', '<leader>u', '20k', opts)
